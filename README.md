...
Application allows for the ability to search videoes, watch videos, and post comments to videos.

Full stack React + Django applications using JWT for authentication/authorization and a fully working register/login system on the React side

## NOTE

"cars" app in Django backend for example purposes only.
